        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8 animate-slide-up">
            ...
            <p className="text-portfolio-gray">
              I'm currently available for freelance work, full-time positions, or consultations in the fields of data science and machine learning. 
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:rasidulislam71@gmail.com" className="text-portfolio-gray hover:text-portfolio-blue transition-colors">
                    rasidulislam71@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:+917596868248" className="text-portfolio-gray hover:text-portfolio-blue transition-colors">
                    +91 7596868248
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-portfolio-gray">Guwahati, India</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-portfolio-blue flex items-center justify-center text-white hover:bg-portfolio-darkBlue transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd"></path>
                  </svg>
                </a>
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-portfolio-blue flex items-center justify-center text-white hover:bg-portfolio-darkBlue transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
